...
Bu proje; **Ahmet Melih Çalış, Ahmet Enes Öztürk ve Emirhan Koçoğlu** tarafından, **puq.ai ana sponsorluğunda** düzenlenen **Base 41 Hackathon** kapsamında geliştirilmiş ve **ikincilik ödülü** kazanmıştır.
...
### Workflow 1: Görüntü işleme ve veri üretimi
...
- NovaVision tabanlı görüntü analizi, GPT-5 Mini destekli öneri üretimi ve Telegram bildirim akışları ayrı servisler / harici workflow bileşenleri olarak çalışmaktadır.
